...
@php
$class = "peer/menu-button flex w-full justify-start items-center gap-2 overflow-hidden rounded-md p-2 text-left
font-normal
ring-sidebar-ring
...
<april:button-link :attributes='$attributes->except("variant")->twMerge([$class])' data-sidebar="menu-button"
    ...
    aria-current="{{$active ? 'page' : ''}}" variant="none" size="none">
    {{$slot}}
</april:button-link>
